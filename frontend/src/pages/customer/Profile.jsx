      ...
      <div className="bg-white border border-border rounded-2xl p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-secondary capitalize">{user?.role?.replace("_", " ")}</p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-2.5 mt-6">
          ...
          <Button variant="ghost" icon={LogOut} className="text-danger hover:bg-danger/5" onClick={handleLogout}>
            Logout
          </Button>
        </div>
      </div>
